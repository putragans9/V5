...
𝘚𝘦𝘸𝘢 𝘉𝘰𝘵 𝘉𝘺 𝘗𝘶𝘵𝘳𝘢𝘟𝘥 𝘖𝘧𝘤
          
┏━━⬣ PRICE LIST 1
┃⬡ 
┃⬡ Sewa Trial Satu Bulan : 5k
┃⬡ Sewa Permanent : 10k 1 Group
┃⬡ Sewa Permanent : 15k All Group
┃⬡ 
┗━━⬣

┏━━⬣ PRICE LIST 2
┃⬡ Jasa Run Bot Whatsapp : 10k
┃⬡ Join Murid Bot : 0k
┃⬡ All Tutor Buat Bot Whatsapp : 5k
┗━━⬣
...
NOTE : BOT ONLINE 24 & FAST RESPON
Nomor : https://wa.me/message/3QRZ3DHA2YPCI1`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `*_${tanggal} - ${time} WIB_*`, buttons: [{ buttonId: `${prefix}payment`, buttonText: { displayText: 'PAYMENT' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 },{ buttonId: `${prefix}gc`, buttonText: { displayText: 'GROUP OFFICIAL' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr]}}}, 'buttonsMessage')
break
case 'tq':
case 'info':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
│
━━━━━━━ •♬• ━━━━━━━`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `*_${tanggal} - ${time} WIB_*`, buttons: [{ buttonId: `${prefix}gc`, buttonText: { displayText: 'ANJAY :V' }, type: 1 }, ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [senderr]}}}, 'buttonsMessage')
break
case 'bayar':
case 'payment':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
...
break
//Sampai sini saya ambil dari Dhani
case 'group':
case 'grup':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: fgi})
if (!isGroup) return reply(mess.only.group)
